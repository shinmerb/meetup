...
- `initialize`メソッドでインスタンス化してメソッドを実行するタイプの問題とクラスメソッドで実行するタイプの問題の2問を解いた

#### 今日のまとめ

- Exercismはテストコードがあり、そこから実装を進めていくため、モブプロがやりやすかった
- まずはテストが通る状態にして、そこからリファクタリングしていった
- 他の回答も確認して自分たちが書いたコードとの違いを調べた
